            ...
            <div className={styles.descargas_escritorio}>
              ...
              {cartas.map((carta, i) => (
                <Link
                  ...
                  to={carta.frontmatter.slug}
                  title={carta.frontmatter.titleseo}
                >
            ...
            <div className={styles.home_background_white}>
              ...
              <div className={styles.contenido_principal}>
                ...
                <div className={styles.col2}>
                  ...
                  <br />
                  <a
                    href="https://www.facebook.com/ElAstronautaRestaurante/"
                    target="_blank"
                    title="El astronauta Restaurante Facebook"
                  >
                    Facebook
                  </a>
                </div>
                <div className={styles.col3}>
                  <a
                    href="https://goo.gl/maps/28ZWQUzKsRvD8Vrf6"
                    target="_blank"
                  >
                    c Diario de Córdoba, 18
                    <br />
                    14002 Córdoba
                  </a>
                </div>
